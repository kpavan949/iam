...
Filename Jagan "F:\Jagan Sas_class3\data\passwd.txt";

Proc pwencode in='vijaya@1234' out=Jagan;
Run;
...
/*Generally we can’t specify our direct passwords in*/
/*program, why because when others know our password’s*/
/*there is a chance to misuse the passwords. To avoid */
/*this problem we need to encrypt our passwords using */
/*PROC PWENCODE that encrypted password we need to apply */
/*in program. This encrypted password having only reading*/
...
/*libname test oracle user='uname' pwd='password';*/
