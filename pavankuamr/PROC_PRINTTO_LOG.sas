...
/*The PRINTTO procedure defines destinations, other
than ODS destinations, for SAS procedure output and for
the SAS log. By default, SAS procedure output and the
SAS log are routed to the default procedure output file
and the default SAS log file for your method of operation.

/*Log print in external file*/

proc printto 
	log="F:\Jagan Sas_class3\data\kneeprob_&sysdate..log";
run;
...
proc printto 
	print="F:\Jagan Sas_class3\data\test_&sysdate..rtf";
run;
