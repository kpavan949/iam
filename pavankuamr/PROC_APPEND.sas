/*PROC APPEND*/
/*The append procedure adds the observation from one sas
dataset to end of the another dataset*/
/*syntax:*/
proc append base=libref.dataset1 data=libref.dataset2
	force;
run;
...
/*BASE DATASET CONTAIN the variables but not in second 
dataset. */
...
/*FORCE*/
/*this is an optional specification that forces proc append*/
/*to concatnate datasets. when we use this append the */
/*datasets force by without checking any conditions like*/
/*present variable, difference in the variable datasets */
/*and length*/
