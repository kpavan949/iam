...
/*It will print the all region names in log window and each values
separated by blanks*/
PROC SQL;
...
%put region name &exp.;
/*First it will extract all distinct records for headcnt then it will
take headcnt*/
/*more than 5*/
...
/*First it will extract where condition and  consider the distinct 
records for headcnt*/
...
%put &rname1. &rname2. &rname3. &rname4. &rname5. &rname6. 
	&rname7. &rname8. &rname9. 
	&rname10. &rname11.;
